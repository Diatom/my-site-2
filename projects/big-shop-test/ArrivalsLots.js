function ArrivalsLots() {
  ...
  return React.createElement("div", { className: "array-lots" }, RequisiteA);
}
...
function ShowcaseLots() {
  ...
  return React.createElement("div", { className: "array-lots" }, RequisiteS);
}
...
ReactDOM.render(
  React.createElement(ArrivalsLots, null),
  document.getElementById("arrivals-lots")
);
ReactDOM.render(
  React.createElement(ShowcaseLots, null),
  document.getElementById("watch-lots")
);
ReactDOM.render(
  React.createElement(ArrivalsLots, null),
  document.getElementById("fashion-lots")
);
